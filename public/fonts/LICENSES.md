...
The font files in this directory are unmodified Latin WOFF2 subsets served by
Google Fonts. They are self-hosted by this site and are not fetched from Google
at runtime.

- `inter-latin-variable.woff2`: Inter 100-900, downloaded from
  `https://fonts.gstatic.com/s/inter/v20/UcC73FwrK3iLTeHuS_nVMrMxCp50SjIa1ZL7.woff2`.
  Upstream: `https://github.com/rsms/inter`.
- `dm-mono-latin-400.woff2`: DM Mono Regular, downloaded from
  `https://fonts.gstatic.com/s/dmmono/v16/aFTU7PB1QTsUX8KYthqQBA.woff2`.
  Upstream: `https://github.com/googlefonts/dm-mono`.
- `dm-mono-latin-500.woff2`: DM Mono Medium, downloaded from
